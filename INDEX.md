...
> [`VERSION`](VERSION) (**1.4.78**) → [`features/README.md`](features/README.md) → that product MD.  
...
> **Client work:** [`features/CLIENT_CHECKLIST.md`](features/CLIENT_CHECKLIST.md) (PIX lab open — test ≥4.9.111)
...
| [features/remote-desktop.md](features/remote-desktop.md) | **≥ 4.9.95** topo · **≥ 4.9.100** pixels · **≥ 4.9.101** SMOOTH · recommend **≥ 4.9.111** |
