...
> [`VERSION`](VERSION) (**1.4.77**) → [`features/README.md`](features/README.md) → that product MD.  
...
> **Cloud work:** [`cloud/CLOUD_CHECKLIST.md`](cloud/CLOUD_CHECKLIST.md) · RD Live paste [`cloud/REMOTE_DESKTOP_JPEG_WS_PRIMARY.md`](cloud/REMOTE_DESKTOP_JPEG_WS_PRIMARY.md)  
> **Client work:** [`features/CLIENT_CHECKLIST.md`](features/CLIENT_CHECKLIST.md) (PIX lab open — test ≥4.9.110)
...
| [features/remote-desktop.md](features/remote-desktop.md) | **≥ 4.9.95** topo · **≥ 4.9.100** pixels · **≥ 4.9.101** SMOOTH · recommend **≥ 4.9.110** |
...
| [cloud/REMOTE_DESKTOP_JPEG_WS_PRIMARY.md](cloud/REMOTE_DESKTOP_JPEG_WS_PRIMARY.md) | Live: JPEG-WS primary · pin ≥4.9.110 |
| [cloud/ATTACKS_NOTIFY_DUAL_CHANNEL.md](cloud/ATTACKS_NOTIFY_DUAL_CHANNEL.md) | Attacks email: NETWORK digest |
