...
- [ ] **C-RD-SMOOTH-1/3/4 live** Honor cloud Start **≥30 / ≥72 / 1920**. Do **not** stay at 8 fps / Q40 in `t:meta`. Coalescing must not lower fps. Lab **4.9.103** showed ~8/Q40 — retest on **≥4.9.106** (≥24 fps JPEG-WS or WebRTC).
