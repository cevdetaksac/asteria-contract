...
> Contract **≥ 1.4.87**. Windows agent this file. Do **not** add new SoT here —
> implement against the linked `features/*` file.
>
> Pin: **≥ 4.9.120** Capture health honesty · **≥ 4.9.119** full `rd_capture_diag` dumps · **≥ 4.9.118** Default post-logon black recovery · **≥ 4.9.117** Welcome follow · **≥ 4.9.116** Server PrintWindow / Active RDP fallback / host prep · **≥ 4.9.115** fail dumps / password→Default · **≥ 4.9.114** LogonUI chrome · **≥ 4.9.113** persistent agent WS ·
