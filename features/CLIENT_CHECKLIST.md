...
> Contract **≥ 1.4.82**. Windows agent this file. Do **not** add new SoT here —
> implement against the linked `features/*` file.
>
> Pin: **≥ 4.9.115** fail dumps / password→Default · **≥ 4.9.114** LogonUI chrome · **≥ 4.9.113** persistent agent WS ·
