...
| Console follow vs lock (`topology=follow` / `winlogon`) | `features/remote-desktop.md` | client **≥ 4.9.95**; pixels + lock/logoff **≥ 4.9.100**; smoothness **≥ 4.9.101**; recommend **≥ 4.9.103** (lab); cloud **1.4.72** |
...
| Client / agent lab tick list | `features/CLIENT_CHECKLIST.md` | client **≥ 4.9.103** RD PIX/SMOOTH lab · **≥ 4.9.95** topo · **≥ 4.9.96** intel/installer |
...
| Remote Desktop (topology, follow, Winlogon, CAD, WebRTC, P0, PIX, smoothness) | `features/remote-desktop.md` | client **≥ 4.9.95** topo · **≥ 4.9.100** lock/logon pixels · **≥ 4.9.101** C-RD-SMOOTH · recommend **≥ 4.9.103** (wire ≥4.9.0; S0 helper ≥4.9.84 must not regress) |
