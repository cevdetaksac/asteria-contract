...
| Cloud / dashboard tick list | `cloud/CLOUD_CHECKLIST.md` | cloud ≥ **1.4.64** |
...
| Bare successful_logon no auto HP-BLOCK; silent-hours alert-only FW; whitelist enforce unblock | `features/threat-engine.md`, `agent/gui-control-center.md` | **4.9.7** |
