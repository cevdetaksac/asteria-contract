...
| Console-first Logon + follow Default after logon (C-RD-FOLLOW / **C-RD-TOPO**) | `cloud/remote-console-parity.md` | client **≥ 4.9.95**; cloud topologies **1.4.59** (lab 4.9.94 follow-skip incomplete) |
