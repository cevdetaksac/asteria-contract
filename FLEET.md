...
| Console follow vs lock (`topology=follow` / `winlogon`) | `features/remote-desktop.md` | client **≥ 4.9.95**; pixels + lock/logoff **≥ 4.9.100**; cloud **1.4.70** |
...
| Client / agent lab tick list | `features/CLIENT_CHECKLIST.md` | client **≥ 4.9.100** RD pixels · **≥ 4.9.95** topo · **≥ 4.9.96** intel/installer |
...
| Remote Desktop (topology, follow, Winlogon, CAD, WebRTC, P0, PIX) | `features/remote-desktop.md` | client **≥ 4.9.95** topo · **≥ 4.9.100** lock/logon pixels (wire ≥4.9.0; S0 helper ≥4.9.84 must not regress) |
